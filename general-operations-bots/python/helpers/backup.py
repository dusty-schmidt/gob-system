...
class BackupService:
    """
    Core backup and restore service for GOB.
    ...
    def __init__(self):
        ...
        self.agent_zero_root = files.get_abs_path("")  # Resolved GOB root
    ...
    def get_default_backup_metadata(self) -> Dict[str, Any]:
        ...
        return {
            "backup_name": f"gob-backup-{timestamp[:10]}",
...
{agent_root}/tmp/uploads/**"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up GOB root path with the current GOB root path
        ...
        for pattern in patterns:
            # Check if the pattern starts with the backed up GOB root
        ...
        try:
            ...
            with zipfile.ZipFile(temp_file, 'r') as zipf:
                ...
                for archive_path in archive_files:
                    ...
                    # so that patterns like "/home/rafael/gob/data/**" can match files correctly
    ...
    def _translate_restore_path(self, archive_path: str, backup_metadata: Dict[str, Any]) -> str:
        ...
        # Check if the archive path starts with the backed up GOB root
